...
const chenYuxuanHealth: HealthData = {
  ...
  indicators: [
    { name: '血压', value: '128/82 mmHg', status: 'high', label: '偏高', reference: '<120/80 mmHg', suggestion: '血压临界偏高，建议低盐饮食、规律运动，2周后复测血压', category: '体格检查' },
    { name: '空腹血糖', value: '5.8 mmol/L', status: 'normal', label: '正常', reference: '3.9-6.1 mmol/L', category: '实验室检查' },
    { name: '总胆固醇', value: '6.1 mmol/L', status: 'high', label: '偏高', reference: '<5.2 mmol/L', suggestion: '总胆固醇偏高，心血管风险增加，建议低脂饮食、增加运动，3个月后复查', category: '实验室检查' },
    { name: '甘油三酯', value: '2.3 mmol/L', status: 'high', label: '偏高', reference: '<1.7 mmol/L', suggestion: '甘油三酯偏高，建议控制碳水摄入、减少饮酒，3个月后复查', category: '实验室检查' },
    { name: '低密度脂蛋白', value: '4.1 mmol/L', status: 'high', label: '偏高', reference: '<3.4 mmol/L', suggestion: '低密度脂蛋白超标，动脉硬化风险升高，建议遵医嘱用药并调整饮食', category: '实验室检查' },
    { name: 'TSH', value: '5.8 mIU/L', status: 'high', label: '偏高', reference: '0.27-4.2 mIU/L', suggestion: 'TSH轻度升高，提示亚临床甲减可能，建议3个月后复查甲功全套', category: '实验室检查' },
    { name: 'BMI', value: '24.8', status: 'high', label: '偏高', reference: '18.5-23.9', suggestion: 'BMI接近超重标准，建议控制饮食总热量，目标减重3-5kg', category: '体格检查' },
    { name: '肝功能(ALT)', value: '22 U/L', status: 'normal', label: '正常', reference: '0-40 U/L', category: '实验室检查' },
    { name: '肾功能(肌酐)', value: '62 μmol/L', status: 'normal', label: '正常', reference: '45-84 μmol/L', category: '实验室检查' },
    { name: '血常规', value: '各项正常', status: 'normal', label: '正常', reference: '-', category: '实验室检查' },
  ],
  ...
  risks: [
    {
      ...
      name: '心血管风险',
      level: 'medium',
      description: '血压临界偏高(128/82 mmHg)，总胆固醇6.1 mmol/L、低密度脂蛋白4.1 mmol/L、甘油三酯2.3 mmol/L均超标。血脂指标较去年进一步升高，动脉粥样硬化风险增加。',
      relatedVisits: ['visit-002', 'visit-003'],
      suggestion: '遵医嘱继续服用他汀类药物，低盐低脂饮食，每日钠摄入控制在5g以内，每周至少150分钟中等强度有氧运动，6周后复查血脂。',
    },
    {
      id: 'risk-002',
      name: '甲状腺功能异常',
      level: 'low',
      description: 'TSH 5.8 mIU/L轻度升高，FT3、FT4正常，符合亚临床甲状腺功能减退诊断标准。目前无明显临床症状，甲状腺彩超未见结节。',
      relatedVisits: ['visit-001'],
      suggestion: '3个月后复查甲状腺功能全套(TSH、FT3、FT4)，观察TSH变化趋势。保持规律作息，避免过度疲劳。如TSH持续升高或出现症状需考虑药物治疗。',
    },
    {
      id: 'risk-003',
      name: '代谢综合征风险',
      level: 'low',
      description: 'BMI 24.8接近超重标准(>=25)，合并血脂异常(总胆固醇、甘油三酯、低密度脂蛋白均超标)，代谢综合征风险因素聚集。',
      relatedVisits: ['visit-002', 'visit-004'],
      suggestion: '控制饮食总热量，目标减重3-5kg使BMI降至24以下。增加膳食纤维摄入，减少精制碳水化合物。配合规律运动，有助于改善血脂代谢。',
    },
  ],
};
