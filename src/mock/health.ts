  ...
  medicalVisits: [
    {
      ...
      department: '心血管内科门诊',
      hospital: '福鑫互联网医院',
      diagnosis: '原发性高血压,高脂血症',
      doctor: '李洁',
      summary: '门诊复诊（流水号 4743398，就诊时间 10:09）。延续原发性高血压与高脂血症诊断，建议持续监测血压波动与血脂达标情况。',
    },
    {
      id: 'visit-002',
      date: '2025-11-03',
      department: '心血管内科',
      hospital: '福鑫互联网医院',
      diagnosis: '头晕,头晕,高血压病3级（极高危）,甲状腺结节,脑血管供血不足,睡眠障碍,动脉粥样硬化,原发性高血压',
      doctor: '李洁',
      summary: '住院治疗（流水号 ZY010000036119，入院时间 10:22）。以头晕为主要症状入院，明确高血压3级（极高危）伴多项靶器官损害。处方：阿利沙坦酯片 240mg QD 降压、阿托伐他汀钙片 10mg QD 调脂、丹红注射液 30ml QD 改善循环，辅以乌灵胶囊 0.99g TID 改善睡眠障碍，0.9%氯化钠注射液 250ml 为输液载体。',
    },
    {
      id: 'visit-003',
      date: '2025-11-03',
      ...
      diagnosis: '高血压',
      doctor: '李洁',
      summary: '门诊就诊（流水号 4718081，就诊时间 10:08）。同日稍早于住院前完成门诊评估，初步诊断为高血压，后收入院进一步诊治。',
    },
  ],
  examRecords: [
    {
  ...
  risks: [
    {
      ...
      relatedVisits: ['visit-001', 'visit-002', 'visit-003'],
