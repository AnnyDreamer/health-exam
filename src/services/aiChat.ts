...
- reason 必须详细说明推荐理由，针对用户的每个关键风险指标或关注方向，逐一解释为什么需要对应的检查项目。格式示例：
  "根据您的情况：1. 血压偏高(128/82)，建议做心脏彩超和颈动脉彩超排查血管病变；2. 血脂三项超标，安排血脂全套和同型半胱氨酸监测动脉硬化风险；3. TSH偏高提示甲状腺功能异常，加入甲状腺功能全套和甲状腺彩超。整体方案覆盖您的主要风险点，帮助早发现早干预。"
  每条理由都要关联到具体的检查项目，让用户理解每个项目的必要性`;
...
export { GUIDED_PACKAGE_SYSTEM_PROMPT };
